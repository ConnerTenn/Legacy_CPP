...
double MaxInitialCellEnergy = 50;
double MinInitialCellEnergy = 30;
double MaxCellEnergy = 1000;
double MaxCellHealth = 20; //10; //100;
double MaxCellAge = 1800 * 1000;
...
void ConvertTime(int time, double *seconds, int *minutes, int *hours, int *days)
{
	//double time, seconds;
	//int days, hours, minutes;
	//time = (double)ElapsedTime / 1000.0;
	*seconds = fmod((double)time / 1000.0, 60.0);
